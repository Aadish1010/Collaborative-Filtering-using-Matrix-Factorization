...
class DataSet:
    ...
    def __init__(self, dataset='movielens', size='S', u=100, i=1000, u_unique=10, i_unique=50, density=0.2, noise=0.3, score_low=1, score_high=5, strong_gen=False, users_size=1.):
        """
        @Parameters:
        ------------
